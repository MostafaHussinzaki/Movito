...
var _genresView = require("./view/genresView");
var _genresViewDefault = parcelHelpers.interopDefault(_genresView);
var _bannerView = require("./view/bannerView");
var _bannerViewDefault = parcelHelpers.interopDefault(_bannerView);
var _weeklyTrendingView = require("./view/weeklyTrendingView");
var _weeklyTrendingViewDefault = parcelHelpers.interopDefault(_weeklyTrendingView);
var _topRatedView = require("./view/topRatedView");
var _topRatedViewDefault = parcelHelpers.interopDefault(_topRatedView);
var _upComingView = require("./view/upComingView");
var _upComingViewDefault = parcelHelpers.interopDefault(_upComingView);
var _movie = require("./view/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
var _sortMovieView = require("./view/SortMovieView");
var _sortMovieViewDefault = parcelHelpers.interopDefault(_sortMovieView);
...
const controlMovie = async function() {
    try {
        ...
        await _model.getMovie(movieId);
        await _model.getList(`movie/${movieId}/recommendations`, "recommendation");
        // render movie
        (0, _movieDefault.default).render(_model.state);
    } catch (err) {
        (0, _movieDefault.default).renderError();
    }
};
const controlGenresList = async function() {
    try {
        ...
        (0, _genresViewDefault.default).render(_model.state.genres);
    } catch (err) {
        (0, _genresViewDefault.default).renderError();
    }
};
const controlBanner = async function() {
    try {
        // load banner
        await _model.getBanner();
        // render banner in Page
        (0, _bannerViewDefault.default).render(_model.state.bannerMovies);
    } catch (err) {
        (0, _bannerViewDefault.default).renderError();
    }
};
const controlUpdateBanner = function() {
    // update banner when change on slider
    (0, _bannerViewDefault.default).update(_model.state.bannerMovies);
};
const controlLists = async function() {
    try {
        // get weeklyTrending
        await _model.getList("trending/movie/week", "weeklyTrending");
        // get top rated
        await _model.getList("movie/top_rated", "topRated");
        // get upComing
        await _model.getList("movie/upcoming", "upComing");
        // render the lists
        (0, _weeklyTrendingViewDefault.default).render(_model.state.weeklyTrending);
        (0, _topRatedViewDefault.default).render(_model.state.topRated);
        (0, _upComingViewDefault.default).render(_model.state.upComing);
    } catch (err) {
        (0, _topRatedViewDefault.default).renderError();
    }
};
const controlGenresMovie = async function() {
    try {
        ...
        if ((genreId[0] === "g" || genreId[0] === "s") && !genreId.includes("p")) {
            _model.state.sort.page = 1;
            _model.clearClassificationList();
        }
        // load the list
        if (genreId[0] === "g") await _model.getGenreLists("g", genreId.slice(1));
        else if (genreId[0] === "s") {
            await _model.getGenreLists("s", genreId.slice(1));
            _model.changeName((0, _sortMovieViewDefault.default).getQuery());
        }
        // render the list in the page
        (0, _sortMovieViewDefault.default).render(_model.state.sort);
    } catch (err) {
        // console.error(err);
        (0, _sortMovieViewDefault.default).renderError();
    }
};
const updateHash = function() {
    let query = (0, _sortMovieViewDefault.default).getQuery();
...
const controlPage = async function() {
    try {
        let genreId = window.location.hash.slice(1);
        // gaurd class for not
        if (genreId[0] !== "g" && genreId[0] !== "s" && !genreId.includes("p=")) return;
        // loading the data according to search or genres
        await _model.getGenreLists(`${genreId[0]}`, genreId.slice(1), _model.state.sort.page);
...
const init = async function() {
    ...
    await controlBanner();
    (0, _bannerViewDefault.default)._addSliderMoviesHandler(controlUpdateBanner);
    await controlLists();
    (0, _movieDefault.default).addMovieDetailHandler(controlMovie);
    (0, _sortMovieViewDefault.default).addGenreMovieHandler(controlGenresMovie); // make genre one
    (0, _sortMovieViewDefault.default).addGenreMovieHandler(controlPage); // make genre one
    (0, _sortMovieViewDefault.default).addSearchHandler(updateHash);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model":"dkYPG","./view/genresView":"kXjzx","./view/bannerView":"2Cq8k","./view/weeklyTrendingView":"btG1E","./view/topRatedView":"697CH","./view/upComingView":"bDymf","./view/movie":"2saRM","./view/SortMovieView":"8QwKc","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "getBanner", ()=>getBanner);
parcelHelpers.export(exports, "getList", ()=>getList);
...
parcelHelpers.export(exports, "clearClassificationList", ()=>clearClassificationList);
parcelHelpers.export(exports, "getGenreLists", ()=>getGenreLists);
...
const getGenres = async function() {
    try {
        let data = await (0, _helpers.getJSON)(`${(0, _config.API)}genre/movie/list?api_key=${(0, _config.API_KEY)}`);
...
const getBanner = async function() {
    try {
        let data = await (0, _helpers.getJSON)(`${(0, _config.API)}discover/movie?api_key=${(0, _config.API_KEY)}`);
...
const getList = async function(restAPI, stateName) {
    try {
        let data = await (0, _helpers.getJSON)(`${(0, _config.API)}${restAPI}?api_key=${(0, _config.API_KEY)}`);
...
const createMovieObject = function(data) {
    ...
    let directorName = data.casts.crew.find((member)=>member.job === "Director").name;
...
const getMovie = async function(id) {
    try {
        let data = await (0, _helpers.getJSON)(`${(0, _config.API)}movie/${id}?append_to_response=casts,videos&api_key=${(0, _config.API_KEY)}`);
...
const changeName = function(q) {
    state.sort.name = state.sort.id = q;
};
const clearClassificationList = function() {
    state.sort.movies = [];
};
const getGenreLists = async function(identifier, id, page = 1) {
    try {
        let data;
        let realId;
        if (identifier === "g") {
            realId = parseFloat(id);
            data = await (0, _helpers.getJSON)(`${(0, _config.API)}discover/movie?api_key=${(0, _config.API_KEY)}&with_genres=${realId}&page=${page}`);
            ...
            identifier = "s";
            realId = id.split("p=")[0];
            data = await (0, _helpers.getJSON)(`${(0, _config.API)}search/movie?query={${realId}}&api_key=${(0, _config.API_KEY)}&page=${page}`);
        ...
        data.results.forEach((mov, i)=>{
            ...
            if (mov.id !== state.sort.movies[i]?.id) state.sort.movies.push(createListMovieObjectSingle(mov));
        });
    } catch (err) {
        throw err;
    }
...
},{"./helpers":"fn2xV","./config":"c93Tb","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fn2xV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./config":"c93Tb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c93Tb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "BASE_IMG", ()=>BASE_IMG);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY);
parcelHelpers.export(exports, "API", ()=>API);
const TIMEOUT_SEC = 20;
const BASE_IMG = "http://image.tmdb.org/t/p/original";
const API_KEY = "3f5af9b71bee4369766ce40a26bd4904";
...
},{}],"kXjzx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class GenresView extends (0, _viewDefault.default) {
...
exports.default = new GenresView();

},{"./View":"ZNUMV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ZNUMV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Cq8k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _playCirclePng = require("url:../../images/play_circle.png");
var _playCirclePngDefault = parcelHelpers.interopDefault(_playCirclePng);
var _config = require("../config");
let currentMovie;
class BannerView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        let currMovie;
        if (!currentMovie) currMovie = 0;
        else currMovie = currentMovie;
        this._parentElement.style.backgroundImage = `url(${0, _config.BASE_IMG}${this._data[currMovie].background})`;
        return `
    ...
    _genrateCurrentMovieMarkup(currentMovie) {
        ...
        <div class="banner__curr-movie">
			...
			<div class="banner__curr-movie__info">
				<div class="banner__curr-movie__info__date">${this._data[currentMovie].date}</div>
				<div class="banner__curr-movie__info__rate | rates">${this._data[currentMovie].rate}</div>
			</div>
			...
			<div class="banner__curr-movie__description">
				<p>
                ${this._data[currentMovie].description.split(".").slice(0, 2).join(".")}
				</p>
			</div>
			<a href="#${this._data[currentMovie].id}" class="banner__curr-movie__button | watch-btn">
				<img src="${0, _playCirclePngDefault.default}" alt="Watch now" />
					<span>Watch now</span>
			</a>
		</div>
        `;
    ...
    _generateSliderMarkup(currentMovie) {
        return `<div class="banner__slider | slider-small"> ${this._data.map((movie, index)=>{
            return `              
              	<div
              		class="banner__slider__poster | poster-img poster-img${index === currentMovie ? "--active" : ""}"
					data-index="${index}"
              	>
              	    <img src="${0, _config.BASE_IMG}${movie.poster}" alt="" />
              	</div>
              `;
        })}</div>`;
    }
}
exports.default = new BannerView();

},{"./View":"ZNUMV","url:../../images/play_circle.png":"6KXmP","../config":"c93Tb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6KXmP":[function(require,module,exports) {
module.exports = require("d7b4b5d1f2ed6cc3").getBundleURL("7tDcp") + "play_circle.68b277ba.png" + "?" + Date.now();

},{"d7b4b5d1f2ed6cc3":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"btG1E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _listsView = require("./listsView");
var _listsViewDefault = parcelHelpers.interopDefault(_listsView);
class WeeklyTrending extends (0, _listsViewDefault.default) {
...
exports.default = new WeeklyTrending();

},{"./listsView":"bfEyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bfEyX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _config = require("../config");
var _starPng = require("url:../../images/star.png");
...
class ListView extends (0, _viewDefault.default) {
    _generateMarkup() {
        let markup = this._data.map((movie)=>{
            let shortenName = movie.name.length > 17 ? `${movie.name.slice(0, 16)}...` : movie.name;
            return `							
            <a class=" | poster" href="#${movie.id}">
                <img src="${0, _config.BASE_IMG}${movie.poster}" alt="${movie.name}" />
                <h2>${shortenName}</h2>
                <div class="">
                    <span class="rate">
                        <img src="${0, _starPngDefault.default}" alt="" />
                        ${movie.rate}
                    </span>
...
},{"./View":"ZNUMV","../config":"c93Tb","url:../../images/star.png":"jF5qq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jF5qq":[function(require,module,exports) {
module.exports = require("d6729837448d9fd").getBundleURL("7tDcp") + "star.0a79a061.png" + "?" + Date.now();

},{"d6729837448d9fd":"lgJ39"}],"697CH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _listsView = require("./listsView");
var _listsViewDefault = parcelHelpers.interopDefault(_listsView);
class TopRatedView extends (0, _listsViewDefault.default) {
...
},{"./listsView":"bfEyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bDymf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _listsView = require("./listsView");
var _listsViewDefault = parcelHelpers.interopDefault(_listsView);
class UpComing extends (0, _listsViewDefault.default) {
    _parentElement = document.querySelector(".up-coming div");
    _errorMessage = "Something went wrong when trying to get Upcoming Movies";
}
exports.default = new UpComing();

},{"./listsView":"bfEyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2saRM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
var _starPng = require("url:../../images/star.png");
var _starPngDefault = parcelHelpers.interopDefault(_starPng);
class Movie extends (0, _viewDefault.default) {
    _parentElement = document.querySelector("main");
    _errorMessage = "Something went wrong when trying to get This movie";
    ...
    _generateMarkup() {
        let recommendations = this._data.recommendation.map((rec)=>{
            let shortenName = rec.name.length > 17 ? `${rec.name.slice(0, 16)}...` : rec.name;
            return `							
         <a class=" | poster" href="#${rec.id}">
             <img src="${0, _config.BASE_IMG}${rec.poster}" alt="${rec.name}" />
             <h2>${shortenName}</h2>
             <div class="">
                 <span class="rate">
                     <img src="${0, _starPngDefault.default}" alt="" />
        ...
        <div class="selected-movie__details" style="background-image: url(${(0, _config.BASE_IMG)}${this._data.movie.background})">
            <div class="selected-movie__details__img | poster">
                <img src="${(0, _config.BASE_IMG)}${this._data.movie.poster}" alt="poster" />
            </div>
            <div class="selected-movie__details__info">
                ...
                <div class="selected-movie__details__info__numbers">
                    <span class="rate"
                        ><img src="${(0, _starPngDefault.default)}" alt="" />${this._data.movie.rate.toFixed(2)}</span
                    >
                    <span class="dot">.</span>
                    <span class="duration">${this._data.movie.runtime}m</span>
                    <span class="dot">.</span>
                    <span class="date">${this._data.movie.date.split("-")[0]}</span>
                    <span class="dot">.</span>
                    <span class="classify | rates">${!this._data.movie.classification ? "PG-13" : "+18"}</span>
                </div>
                <div class="selected-movie__details__info__description">
                    <div class="genres"><p>${this._data.movie.genre.join(", ")}</p></div>
                    <div class="summary">
                        <p>
...
},{"./View":"ZNUMV","../config":"c93Tb","url:../../images/star.png":"jF5qq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8QwKc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
var _starPngDefault = parcelHelpers.interopDefault(_starPng);
var _regeneratorRuntime = require("regenerator-runtime");
class SortMovie extends (0, _viewDefault.default) {
    _parentElement = document.querySelector("main");
    ...
    _generateMarkup() {
        ...
        let movies = this._data.movies.map((movie)=>{
            let shortenName = movie.name.length > 17 ? `${movie.name.slice(0, 16)}...` : movie.name;
            return `							
            <a class=" | poster" href="#${movie.id}">
                <img src="${0, _config.BASE_IMG}${movie.poster}" alt="${movie.name}" />
        ...
        let markup = this._data.movies.length > 0 ? `
        <div class="sorts">
			<h1>${this._data.name} Movie</h1>
			<div class="movies">
				${movies}
			</div>
			${this._data.totalPage <= this._data.page ? "" : `<a href="#${window.location.hash[1]}${this._data.id}p=${this._data.page}" class="sorts__btn | watch-btn ">
...
exports.default = new SortMovie();

},{"./View":"ZNUMV","../config":"c93Tb","url:../../images/star.png":"jF5qq","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["klTFg","2dUup"], "2dUup", "parcelRequire9e6e")
